...
2. The [Nest Filter](https://github.com/fluent/fluent-bit-docs/tree/750e6aded3e943b9525cc4894487423d04df0418/output/filter/nest.md), unnests fields inside `log` key. In our example, it puts `data` alongside `stream` and `time`.
3. We used this `data` key as `Gelf_Short_Message_Key`; so GELF plugin changes it to `short_message`.
4. [Kubernetes Filter](https://github.com/fluent/fluent-bit-docs/tree/750e6aded3e943b9525cc4894487423d04df0418/output/filter/kubernetes.md) adds `host` name.
