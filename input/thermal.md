...
The **thermal** input plugin reports system temeratures at the given time interval, one minute by default. At the moment this plugin is only available for Linux.
