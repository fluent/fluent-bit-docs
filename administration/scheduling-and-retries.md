...
| Retry\_Limit | no_retries | When Retry\_Limit is set to no_retries, means that reries are disabled and Scheduler would not try to send data to destination if it failed first time. |
