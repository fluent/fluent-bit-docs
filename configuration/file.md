...
Fluent Bit allows to use one configuration file which works at a global scope and uses the [schema](https://github.com/fluent/fluent-bit-docs/tree/a0d186414382b07a49596da3966df7ee34c78538/configuration/configuration_schema.md) defined previously.
