...
Fluent Bit allows to use one configuration file which works at a global scope and uses the [schema](https://github.com/fluent/fluent-bit-docs/tree/75db9ab415d97ce204eaf8939fe936d754a174d1/configuration/configuration_schema.md) defined previously.
