...
| Ignore\_Older | Ignores files which modification date is older than this time in seconds. Supports m,h,d \(minutes, hours, days\) syntax. Configuring this option can improve performance when your Path matches a lot of older files that are no longer being actively modified.                                                                                                                                                                                                                                |  |
