...
| \_severity\_key | The value of this field is used by the Stackdriver output plugin to find the related label from jsonPayload and then extract the value of it to set the top level severity field. | |
