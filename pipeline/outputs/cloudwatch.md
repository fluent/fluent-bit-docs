...
| `role_arn`            | The value of this option must be ARN of an IAM role. This role will be assumed using an `sts:AssumeRole` call. This parameter is typically used to send logs from one AWS account to another.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `auto_create_group`   | Automatically create the log group. Valid values are `true`/`on` and `false`/`off` (case insensitive). Defaults to `false`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `log_retention_day`s  | If set to a number greater than zero, and newly create log group's retention policy is set to this many days. Valid values are: \[1, 3, 5, 7, 14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1827, 3653]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
