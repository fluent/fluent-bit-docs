...
| parquet.process\_dir            | Specify a temporary directory for processing parquet objects. This paramater is effective for non Windows platforms.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Windows: %TMP_DIR%\parquet\s3 Linux/macOS: /tmp/parquet/s3 |
