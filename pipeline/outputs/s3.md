...
| upload_chunk_size             | The size of each 'part' for multipart uploads. For uncompressed uploads, the max is 50M. For compressed uploads, the max is 5G. This is the size of the buffered data before compression is applied, so the actual uploaded chunk will be smaller. The min upload_chunk_size in all cases is restricted in the S3 API to 5,242,880 bytes. If after compression, the chunk is smaller than that size, the plugin will upload the chunk using the PutObject API instead                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 5,242,880 bytes                         |
...
| compression                   | Compression type for S3 objects. 'gzip' is currently the only supported value by default. The Content-Encoding HTTP Header will be set to 'gzip'. If Apache Arrow support was enabled at compile time, you can set 'arrow' to this option. Compression 'gzip' can be enabled with both use_put_object on or off. Apache 'arrow' compression can only be enabled with use_put_object` on.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | None                                    |
