...
| server\_side\_encryption         | Server-side encryption scheme to use.  'AES256' or 'aws:kms' [are the only supported values](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObject.html#API_PutObject_ResponseSyntax).  No server-side encryption is the default.
