...
Use the [HTTP output plugin](./http.md) to flush your records [into Observe](https://docs.observeinc.com/docs/fluent-bit). It issues a POST request with the data records in [MessagePack](https://msgpack.org) (or JSON) format.
